...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('🔍 JWT Authentication Diagnostic Tool\n')
        )
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(f'❌ Diagnostic failed with error: {e}')
            )
            if self.verbose:
                    ...
                    if key_manager.keys_exist():
                        ...
                        if private_perms != '600':
                            ...
                            if options.get('fix_permissions'):
                                ...
                                self.stdout.write(self.style.SUCCESS("  ✅ Fixed private key permissions"))
        ...
        try:
            ...
            for i, auth_class in enumerate(auth_classes):
                ...
                try:
                    ...
                    info.append(f"     ✅ Import successful")
                except ImportError as e:
    ...
    def provide_summary_and_recommendations(self, results):
        ...
        if all_issues:
            ...
            self.stdout.write(self.style.SUCCESS('\n✅ All checks passed! JWT authentication should be working correctly.'))
