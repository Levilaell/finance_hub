...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_type', models.CharField(choices=[('checking', 'Conta Corrente'), ('savings', 'Conta Poupança'), ('business', 'Conta Empresarial'), ('digital', 'Conta Digital'), ('credit_card', 'Cartão de Crédito')], max_length=20, verbose_name='account type')),
                ...
                ('external_id', models.CharField(blank=True, max_length=100, verbose_name='external account ID')),
                ('pluggy_item_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='Pluggy item ID')),
                ('_access_token_encrypted', models.TextField(blank=True, verbose_name='encrypted access token')),
                ('_refresh_token_encrypted', models.TextField(blank=True, verbose_name='encrypted refresh token')),
                ...
                ('bank_provider', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='banking.bankprovider')),
            ],
            options={
