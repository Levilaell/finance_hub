    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('WAITING_USER_INPUT', 'Waiting User Input'), ('UPDATING', 'Updating'), ('UPDATED', 'Updated'), ('LOGIN_ERROR', 'Login Error'), ('OUTDATED', 'Outdated')], default='CREATED', max_length=30, verbose_name='status')),
                ('execution_status', models.CharField(blank=True, choices=[('CREATED', 'Created'), ('LOGIN_IN_PROGRESS', 'Login In Progress'), ('LOGIN_MFA_IN_PROGRESS', 'Login MFA In Progress'), ('ACCOUNTS_IN_PROGRESS', 'Accounts In Progress'), ('CREDITCARDS_IN_PROGRESS', 'Credit Cards In Progress'), ('TRANSACTIONS_IN_PROGRESS', 'Transactions In Progress'), ('INVESTMENT_TRANSACTIONS_IN_PROGRESS', 'Investment Transactions In Progress'), ('PAYMENT_DATA_IN_PROGRESS', 'Payment Data In Progress'), ('IDENTITY_IN_PROGRESS', 'Identity In Progress'), ('MERGING', 'Merging'), ('ERROR', 'Error'), ('MERGE_ERROR', 'Merge Error'), ('INVALID_CREDENTIALS', 'Invalid Credentials'), ('ALREADY_LOGGED_IN', 'Already Logged In'), ('SITE_NOT_AVAILABLE', 'Site Not Available'), ('INVALID_CREDENTIALS_MFA', 'Invalid Credentials MFA'), ('USER_INPUT_TIMEOUT', 'User Input Timeout'), ('ACCOUNT_LOCKED', 'Account Locked'), ('ACCOUNT_NEEDS_ACTION', 'Account Needs Action'), ('USER_NOT_SUPPORTED', 'User Not Supported'), ('ACCOUNT_CREDENTIALS_RESET', 'Account Credentials Reset'), ('CONNECTION_ERROR', 'Connection Error'), ('USER_AUTHORIZATION_NOT_GRANTED', 'User Authorization Not Granted'), ('USER_AUTHORIZATION_REVOKED', 'User Authorization Revoked'), ('WAITING_USER_INPUT', 'Waiting User Input'), ('USER_AUTHORIZATION_PENDING', 'User Authorization Pending'), ('SUCCESS', 'Success'), ('PARTIAL_SUCCESS', 'Partial Success')], max_length=50, verbose_name='execution status')),
                ('pluggy_created_at', models.DateTimeField(verbose_name='Pluggy created at')),
                ('pluggy_updated_at', models.DateTimeField(verbose_name='Pluggy updated at')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['pluggy_id'], name='pluggy_conn_pluggy__d79f04_idx'),
        ),
        migrations.AddIndex(
            model_name='pluggyconnector',
            index=models.Index(fields=['type', 'country'], name='pluggy_conn_type_60ce39_idx'),
        ),
        migrations.AddIndex(
            model_name='pluggyconnector',
            index=models.Index(fields=['is_open_finance'], name='pluggy_conn_is_open_eaa2e6_idx'),
        ),
        migrations.AddField(
            model_name='pluggycategory',
            name='internal_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pluggy_mappings', to='banking.transactioncategory'),
        ),
        migrations.AddField(
            model_name='itemwebhook',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='webhooks', to='banking.pluggyitem'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bankaccount',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='accounts', to='banking.pluggyitem'),
        ),
        migrations.AddIndex(
