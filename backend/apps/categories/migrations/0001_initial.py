...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method', models.CharField(choices=[('ai', 'Predição IA'), ('rule', 'Baseado em Regras'), ('manual', 'Manual'), ('bulk', 'Operação em Massa'), ('recurring', 'Padrão Recorrente')], max_length=20, verbose_name='categorization method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_source', models.CharField(choices=[('manual', 'Revisão Manual'), ('user_feedback', 'Feedback do Usuário'), ('rule_based', 'Baseado em Regras'), ('ai_confident', 'IA Alta Confiança')], default='manual', max_length=20, verbose_name='verification source')),
