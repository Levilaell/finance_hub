    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_type', models.CharField(choices=[('free', 'Grátis'), ('starter', 'Inicial'), ('professional', 'Profissional'), ('enterprise', 'Empresarial')], max_length=20, verbose_name='plan type')),
                ...
                ('gateway_plan_id', models.CharField(blank=True, help_text='ID do plano/preço no gateway de pagamento (Stripe/MercadoPago)', max_length=255, verbose_name='payment gateway plan ID')),
