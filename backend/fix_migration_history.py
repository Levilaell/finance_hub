        ...
        if companies_0009 in applied_migrations and companies_0008 not in applied_migrations:
            ...
            with connection.cursor() as cursor:
                ...
                if has_created_at and has_updated_at:
                    ...
                    print("⚠️  [MIGRATION-FIX] Estrutura da 0008 não existe completamente")
                    print("🔧 [MIGRATION-FIX] Aplicando correção diferencial da migração 0008...")
                    
                    # Usar o script diferencial para aplicar as partes faltantes
                    from fix_companies_0008_differential import main as fix_0008_differential
                    
                    if fix_0008_differential():
                        print("✅ [MIGRATION-FIX] Correção diferencial da 0008 bem-sucedida")
                        return True
                    else:
                        print("❌ [MIGRATION-FIX] Falha na correção diferencial da 0008")
                        return False
        else:
