    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-blue-50 rounded-lg p-4">
          <p className="text-sm text-blue-600 font-medium">Novos</p>
          <p className="text-2xl font-bold text-blue-900">{newInsights.length}</p>
        </div>
        <div className="bg-yellow-50 rounded-lg p-4">
          <p className="text-sm text-yellow-600 font-medium">Em Progresso</p>
          <p className="text-2xl font-bold text-yellow-900">{inProgressInsights.length}</p>
        </div>
        <div className="bg-green-50 rounded-lg p-4">
          <p className="text-sm text-green-600 font-medium">Concluídos</p>
          <p className="text-2xl font-bold text-green-900">{completedInsights.length}</p>
        </div>
