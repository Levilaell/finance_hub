      ...
      <div className="space-y-8 pb-8">
        ...
        <div className="bg-card border border-white/10 rounded-lg p-6">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-md p-3">
              <h4 className="font-semibold text-amber-300 mb-2">Vincular transação com valor diferente:</h4>
              <ul className="space-y-1 text-sm text-amber-200/80">
                <li>Você pode vincular uma transação mesmo que o valor seja diferente da conta</li>
                <li>O sistema registra automaticamente como <strong>pagamento parcial</strong></li>
                <li>Se a transação for maior que o restante, apenas o valor restante é registrado</li>
                <li>Na lista de transações, clique nos 3 pontos &gt; <strong>&quot;Vincular a Conta&quot;</strong> para ver todas as contas disponíveis</li>
              </ul>
            </div>
          ...
          <div className="mt-4 space-y-3">
            <div className="bg-pink-500/10 border border-pink-500/20 rounded-md p-3">
              ...
              <ul className="space-y-1 text-sm text-pink-200/80">
                <li>Organize suas categorias em dois níveis (ex: Alimentação &gt; Restaurantes)</li>
        ...
        <div className="bg-card border border-white/10 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">Regras de Categorização Automática</h3>
          </div>
          <p className="text-muted-foreground mb-3">Automatize a categorização das suas transações:</p>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2">
              <CheckCircleIcon className="h-4 w-4 text-emerald-400" />
              <span><strong className="text-white">Crie regras:</strong> defina padrões de texto para categorizar automaticamente</span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircleIcon className="h-4 w-4 text-emerald-400" />
              <span><strong className="text-white">Tipos de match:</strong> Prefixo, Contém ou Aproximado</span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircleIcon className="h-4 w-4 text-emerald-400" />
              <span><strong className="text-white">Aplicar a existentes:</strong> aplique regras a transações já importadas</span>
            </li>
            <li className="flex items-center gap-2">
              <CheckCircleIcon className="h-4 w-4 text-emerald-400" />
              <span><strong className="text-white">Localização:</strong> Configurações &gt; Automação</span>
            </li>
          </ul>
          <div className="mt-4 space-y-3">
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-md p-3">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-emerald-200/80">
                ...
                <li>Clique na aba <strong>&quot;Automação&quot;</strong></li>
                <li>Clique em <strong>&quot;Nova Regra&quot;</strong></li>
                <li>Defina o padrão (ex: &quot;uber&quot;, &quot;pix enviado&quot;)</li>
                <li>Escolha o tipo de match e a categoria</li>
                <li>Marque &quot;Aplicar a transações existentes&quot; se desejar</li>
              </ol>
            </div>
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-md p-3">
              <div className="flex gap-2">
                <CheckCircleIcon className="h-5 w-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <div className="text-sm text-blue-200/80">
                  <strong className="text-blue-300">Dica:</strong> Ao categorizar uma transação manualmente, marque &quot;Criar regra&quot; para que transações similares sejam categorizadas automaticamente no futuro
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 border border-indigo-500/20 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li className="flex items-start gap-2">
              <CheckCircleIcon className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
              <span><strong className="text-white">Crie regras de categorização</strong> para automatizar a organização das transações</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircleIcon className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
              <span><strong className="text-white">Use subcategorias</strong> para organizar melhor seus gastos (ex: Alimentação &gt; Restaurantes)</span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircleIcon className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5" />
