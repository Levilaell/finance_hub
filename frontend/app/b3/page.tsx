...
export default function LandingB3Page() {
  return (
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed">
                    A maior parte do trabalho de BPO financeiro é organizar transações. O CaixaHub faz isso com IA por R$ 97/mês.
                  </p>
                </div>
              ...
              >
                <div className="relative rounded-2xl overflow-hidden border border-border/50 shadow-2xl bg-card">
                  <Image
                    ...
                    alt="Dashboard CaixaHub - Economia em BPO"
                    width={1200}
                    height={675}
              ...
              <Card className="p-8">
                <div className="text-xl text-muted-foreground leading-relaxed space-y-6">
                  ...
                  <p className="text-foreground font-semibold text-2xl">
                    Mas pra clareza financeira? Paga R$ 97, não R$ 1.500.
                  </p>
                </div>
              </Card>
            </motion.div>
